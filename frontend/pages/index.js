            ...
            <div className={styles['application-list']}>
                {applications.map((application) => (
                    <div key={application._id} className={styles['application-item']}>
                        ...
                        <button onClick={() => router.push(`/edit/${application._id}`)}>Edit</button>
                        <button onClick={() => handleDelete(application._id)}>Delete</button><br />
                    </div>
                ))}
            </div><br />
            <div >
                <button className={styles['add-button']} onClick={() => router.push('/add')} >Add New Application</button>
            </div>
        </div>
    );
}
